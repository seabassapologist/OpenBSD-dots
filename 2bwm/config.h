...
///---Modifiers---///
#define MOD             XCB_MOD_MASK_1       /* Alt key */
...
static const uint8_t offsets[] = {0,28,0,28};
...
static const uint8_t borders[] = {4,8,8,4};
...
static const char *xmenucmd[]   = { "/home/matt/Code/xmenu/xmenu.sh", NULL };
...
static Button buttons[] = {
    ...
    {  0          ,XCB_BUTTON_INDEX_3,     start,         {.com = xmenucmd}, true},
